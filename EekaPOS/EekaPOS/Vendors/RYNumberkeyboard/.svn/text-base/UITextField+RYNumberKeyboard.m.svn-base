...
- (void)setRy_inputDelegate:(id<RYNumberKeyboardDelegate>)ry_inputDelegate
{
   self.ry_inputDelegate = ry_inputDelegate;
}
#pragma mark -
#pragma mark -  Getter
...
- (id<RYNumberKeyboardDelegate>)ry_inputDelegate
{
    return objc_getAssociatedObject(self, @selector(ry_inputDelegate));
}
